...
vim.keymap.set('n', '<leader>j', ':DapLoadLaunchJSON<CR>')
vim.keymap.set('n', '<leader>x', ':DapDisconnect<CR>')
...
require('lazy').setup({
  ...
  {
    'numToStr/Comment.nvim', -- gcc to comment line, gc to comment selection
    opts = {},
  },
  {
  ...
  },
  {
    ...
    config = function()
      ...
      dap.listeners.before.event_terminated['dapui_cofig'] = function()
        dapui.close()
      end
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>lg', require('telescope.builtin').lsp_definitions, '[G]oto [D]efinition')
          ...
          map('<leader>lx', vim.lsp.buf.code_action, '[C]ode [A]ction', { 'n', 'x' })
